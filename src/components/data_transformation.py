...
class DataTransformation:
    ...
    def get_data_transformer_object(self):
        ...
        try:
            ...
            cat_pipeline=Pipeline(
                steps=[("imputer",SimpleImputer(strategy="most_frequent")),("onehotencoder",OneHotEncoder())
    ...
    def initiate_data_transformation(self,train_path,test_path):
        try:
            ...
            save_obj(file_path=self.datatransformation_config.preprocessor_ob_file_path,
                     obj=preprocessing_obj)

            return (
                train_arr,test_arr,self.datatransformation_config.preprocessor_ob_file_path
            )
